...
Original file is located at
    https://colab.research.google.com/drive/1W2O4bgdYaHRgZSt4u4fvPcO8cCMOc8LM
...
def planes(*args):
    ...
    """Función para visualizar plano tridimensionales"""
...
def lines(*args):
    ...
    """Función para visualizar rectas tridimensionales"""
...
def lines(*args):
    ...
    for V in args:
        ...
        if type(V)== dict:
            ...
            color = randomRgbaColor()
            #nombre = "x = " + str(xi) + str(a) + ", " + "y = " + str(yi) + str(b) + ", " + "z = " + str(yi) +  str(b)
    ...
    fig.update_layout(legend=dict(orientation="h",y=1.3,x=0.03),title_font=dict(size=50, color='rgb(1,21,51)'),showlegend=True,width=500, height=500)
    
    plt(fig,image_height=900,image_width=900)
    fig.show()
...
def points(*args):
    ...
    """Función para visualizar puntos en el espacio tridimensionales"""
